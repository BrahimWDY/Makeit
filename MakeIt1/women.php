			...
			<!-- Nav -->
				<nav id="men">
					<ul class="links">
						...
						<li class="current"><a href="#">Femme</a></li>
							...
							<div id="myCarousel" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									...
									<div id="slide" class="item active">
										<img class="slide_auto" src="images/slide/slidefem1.png" alt="Los Angeles">
									...
									<div id="slide" class="item">
										<img class="slide_auto" src="images/slide/slidefem2.png" alt="Chicago">
										<div class="carousel-caption">
											<!-- <h3>Chicago</h3>
									...
									<div id="slide" class="item">
										<img class="slide_auto" src="images/slide/slidefem3.png" alt="New York">
										<div class="carousel-caption">
											<!-- <h3>New York</h3>
									...
									<div class="row img-part ">
										<div class="col-md-12 col-sm-12 colxs-12 img-section ">
											<div class="opacity-color">
												<a href="#">
													<img src="images/femme/femme 1.png">
												</a>
											</div>
										</div>
								...
								<div class="col-md-4 col-sm-12 col-xs-12 image-main-section">
									<div class="row img-part">
										<div class="col-md-12 col-sm-12 colxs-12 img-section">
											<div class="opacity-color">
												<a href="#">
													<img src="images/femme/femme 2.png">
												</a>
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 image-title">
								...
								<div class="col-md-4 col-sm-12 col-xs-12 image-main-section">
									<div class="row img-part">
										<div class="col-md-12 col-sm-12 colxs-12 img-section">
											<div class="opacity-color">
												<a href="#">
													<img src="images/femme/femme 3.png">
												</a>
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 image-title">
								...
								<div class="col-md-4 col-sm-12 col-xs-12 image-main-section">
									<div class="row img-part">
										<div class="col-md-12 col-sm-12 colxs-12 img-section">
											<div class="opacity-color">
												<a href="#">
													<img src="images/femme/femme 4.png">
												</a>
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 image-title">
								...
								<div class="col-md-4 col-sm-12 col-xs-12 image-main-section">
									<div class="row img-part">
										<div class="col-md-12 col-sm-12 colxs-12 img-section">
											<div class="opacity-color">
												<a href="#">
													<img src="images/femme/femme 5.png">
												</a>
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 image-title">
								...
								<div class="col-md-4 col-sm-12 col-xs-12 image-main-section">
									<div class="row img-part">
										<div class="col-md-12 col-sm-12 colxs-12 img-section">
											<div class="opacity-color">
												<a href="#">
													<img src="images/femme/femme 6.png">
												</a>
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 image-title">
